...
class AddressCore extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'phone' => ['type' => self::TYPE_STRING, 'validate' => 'isPhoneNumber', 'isUnsignedId', 'required' => true, 'size' => 32],
            'phone_mobile' => ['type' => self::TYPE_STRING, 'validate' => 'isPhoneNumber', 'isUnsignedId', 'required' => true, 'size' => 32],
